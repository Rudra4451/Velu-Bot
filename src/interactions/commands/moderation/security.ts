...
export async function execute(interaction: ChatInputCommandInteraction): Promise<void> {
  ...
  if (subcommand === 'automod') {
    db.updateConfig(guildId, 'automodEnabled', enabled);
    ...
    db.updateConfig(guildId, 'automodSpamFilter', enabled);
    ...
    db.updateConfig(guildId, 'automodBlockInvites', enabled);
    ...
    db.updateConfig(guildId, 'automodBadwords', enabled);
